  ...
  return (
    <group>
      ...
      <mesh position={[0, 0.95, 0]}>
        ...
        <ToonMat color="#d4a830" emissive="#b89420" emissiveIntensity={0.35}/>
      </mesh>
      <mesh position={[0, 0.78, 0.12]}>
        <boxGeometry args={[0.04, 0.18, 0.04]} />
        <ToonMat color="#8a7020"/>
      </mesh>
    </group>
  )
}
  ...
  return (
    <group>
      <mesh position={[0, 0.35, 0]}>
        ...
        <ToonMat color="#88a8c0"transparent opacity={0.75}/>
      </mesh>
      ...
      {[
        ...
        <mesh key={i} position={[x, y, z]}>
          ...
          <ToonMat color="#c8ff80" emissive="#90ff40" emissiveIntensity={1.4}/>
        </mesh>
      ))}
  ...
  return (
    <group>
      ...
      {petals.map(([x, y, z], i) => (
        <mesh key={i} position={[x, y, z]}>
          <sphereGeometry args={[0.1, 5, 4]} />
          <ToonMat color={colors[i % colors.length]}emissive={colors[i % colors.length]} emissiveIntensity={0.15} />
        </mesh>
      ))}
      <mesh position={[0, 0.12, 0]}>
        <sphereGeometry args={[0.08, 5, 4]} />
        <ToonMat color="#efd85a"emissive="#d0b030" emissiveIntensity={0.25} />
      </mesh>
    </group>
  )
}
